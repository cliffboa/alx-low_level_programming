 ...
 *         If the allocation fails, exits with code 99.
 */
char *create_buffer(char *file)
{
    char *buffer;
 ...
 *
 * Return: None.
 *         If closing the file descriptor fails, exits with code 100.
 */
void close_file(int fd)
{
    int close_result;
 ...
 *
 * Description:
 * - If the argument count is incorrect, exits with code 97.
